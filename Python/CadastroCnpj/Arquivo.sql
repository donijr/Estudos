...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '(21) 2155-4551/ (21) 2155-4552' -- cod_part
                              , '_nome_' -- nome
                              , 1 -- dm_tipo_pessoa
                              , '_fantasia_' -- fantasia
                              , '_logradouro_' -- lograd
                              ...
                              , '_complemento_' -- compl
                              , '_bairro_' -- bairro
                              , (select ci.id from csf_own.cidade ci where ci.descr = '_municipio_') -- cidade_id
                              , _cep_ -- cep 
                              , '_telefone_' -- fone
                              , '' -- fax
                              , '_email_' -- email
                              , (select es.pais_id from csf_own.estado es where es.id = (select ci.estado_id from csf_own.cidade ci where ci.descr = '_municipio_')) -- pais_id
   ...
   insert into csf_own.juridica ( id
                         ...
                         values ( csf_own.juridica_seq.nextval -- id
                                ...
                                , XXXXXXXXXXXXXXX -- num_cnpj
                                , XXXXXXXXXXXXXXX -- num_filial
                                , XXXXXXXXXXXXXXX -- dig_cnpj
                                , '' -- ie
                                , '' -- iest
                                , '' -- im
                                , '' -- cnae
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , 'XXXXXXXXXXXXXXX' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
