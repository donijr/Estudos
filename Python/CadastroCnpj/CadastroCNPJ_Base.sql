...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '27865757000102' -- cod_part
                              , 'GLOBO COMUNICACAO E PARTICIPACOES S/A' -- nome
                              , 1 -- dm_tipo_pessoa
                              , 'TV/REDE/CANAIS/G2C+GLOBO SOMLIVRE GLOBO.COM GLOBOPLAY' -- fantasia
                              , 'R LOPES QUINTAS' -- lograd
                              , '303' -- nro
                              , '' -- cx_postal
                              , '' -- compl
                              , 'JARDIM BOTANICO' -- bairro
                              , (select ci.id from csf_own.cidade ci where ci.descr = 'Rio De Janeiro') -- cidade_id
                              , 22460901 -- cep 
                              , '(21) 2155-4551/ (21) 2155-4552' -- fone
                              , '' -- fax
                              , '' -- email
                              , (select es.pais_id from csf_own.estado es where es.id = (select ci.estado_id from csf_own.cidade ci where ci.descr = 'Rio De Janeiro')) -- pais_id
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/27865757000102' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
