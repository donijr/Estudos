...
begin
   ...
   insert into csf_own.juridica ( id
                         ...
                         values ( csf_own.juridica_seq.nextval -- id
                                ...
                                , _numeroCnpj_ -- num_cnpj
                                , _numeroFilial_ -- num_filial
                                , _digitoCnpj_ -- dig_cnpj
                                , '' -- ie
                                , '' -- iest
                                , '' -- im
                                , '' -- cnae
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '_caminhoPastaIntegra_' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
