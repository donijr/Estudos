...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '01971614000183' -- cod_part
                              , 'EMPRESA NACIONAL DE COMERCIO, REDITO E PARTICIPACOES S.A.-ENCORPAR' -- nome
                              , 1 -- dm_tipo_pessoa
                              , 'ENCORPAR' -- fantasia
                              , 'RUA AIMORES' -- lograd
                              , '981' -- nro
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/01971614000183' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
