...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '05514717000175' -- cod_part
                              , 'SEDA SOCIEDADE ANONIMA' -- nome
                              , 1 -- dm_tipo_pessoa
                              , '' -- fantasia
                              , 'R DOS AIMORES' -- lograd
                              , '981' -- nro
                              , '' -- cx_postal
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/05514717000175' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
