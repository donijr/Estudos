...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '06316597000164' -- cod_part
                              , 'OXFORD COMERCIO E PARTICIPACOES S.A.' -- nome
                              , 1 -- dm_tipo_pessoa
                              , 'OXFORD COMERCIO E PARTICIPACOES S.A.' -- fantasia
                              , 'RUA AIMORES' -- lograd
                              , '981' -- nro
                              , '' -- cx_postal
                              , '12 ANDAR - PARTE' -- compl
                              , 'FUNCIONARIOS' -- bairro
                              , (select ci.id from csf_own.cidade ci where ci.descr = 'Belo Horizonte') -- cidade_id
                              , 30140071 -- cep 
                              , '3132741877' -- fone
                              , '' -- fax
                              , 'mamorim@coteminas.com.br' -- email
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/06316597000164' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
