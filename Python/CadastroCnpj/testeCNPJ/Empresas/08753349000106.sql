...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '08753349000106' -- cod_part
                              , 'DESTILARIA GOIAS S.A' -- nome
                              , 1 -- dm_tipo_pessoa
                              , '' -- fantasia
                              , 'RODOVIA MUNICIPAL A TUVERLANDIA' -- lograd
                              , 'S/N' -- nro
                              , '' -- cx_postal
                              , 'KM 28' -- compl
                              , 'ZONA RURAL' -- bairro
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/08753349000106' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
