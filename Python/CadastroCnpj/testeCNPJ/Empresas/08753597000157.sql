...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '08753597000157' -- cod_part
                              , 'CIA DE ACUCAR E ALCOOL PORTO ESTRELA' -- nome
                              , 1 -- dm_tipo_pessoa
                              , '' -- fantasia
                              , 'RODOVIA PARAUNA A MONTIVIDEL' -- lograd
                              , 'S/N' -- nro
                              , '' -- cx_postal
                              , 'KM 23' -- compl
                              , 'FAZENDA GAMELEIRA DA BOA VISTA' -- bairro
                              , (select ci.id from csf_own.cidade ci where ci.descr = 'Parauna') -- cidade_id
                              , 75980000 -- cep 
                              , '6232653265' -- fone
                              , '' -- fax
                              , '' -- email
                              , (select es.pais_id from csf_own.estado es where es.id = (select ci.estado_id from csf_own.cidade ci where ci.descr = 'Parauna')) -- pais_id
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/08753597000157' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
