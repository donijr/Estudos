...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '14901978000139' -- cod_part
                              , 'AAURA DESENVOLVIMENTO DE SOFTWARE LTDA' -- nome
                              , 1 -- dm_tipo_pessoa
                              , 'A AURA' -- fantasia
                              , 'AVENIDA PAULISTA' -- lograd
                              , '1754' -- nro
                              , '' -- cx_postal
                              , 'SLJ 2 PARTE C' -- compl
                              , 'CERQUEIRA CESAR' -- bairro
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/14901978000139' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
