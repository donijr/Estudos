...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '17749864000103' -- cod_part
                              , 'SANTANENSE EMPREENDIMENTOS IMOBILIARIOS LTDA' -- nome
                              , 1 -- dm_tipo_pessoa
                              , 'SANTANENSE EMPREENDIMENTOS IMOBILIARIOS' -- fantasia
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/17749864000103' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
