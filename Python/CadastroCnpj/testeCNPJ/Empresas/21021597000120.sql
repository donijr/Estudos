...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '21021597000120' -- cod_part
                              , 'ENCORPAR INVESTIMENTOS LTDA' -- nome
                              , 1 -- dm_tipo_pessoa
                              , '' -- fantasia
                              , 'RUA AIMORES' -- lograd
                              , '981' -- nro
                              , '' -- cx_postal
                              , '11 ANDAR - PARTE' -- compl
                              , 'FUNCIONARIOS' -- bairro
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/21021597000120' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
