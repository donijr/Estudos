...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '21255567000189' -- cod_part
                              , 'COMPANHIA TECIDOS SANTANENSE' -- nome
                              , 1 -- dm_tipo_pessoa
                              , '' -- fantasia
                              , 'AV OSMANE BARBOSA' -- lograd
                              , '1235' -- nro
                              , '' -- cx_postal
                              , '' -- compl
                              , 'J.K.' -- bairro
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/21255567000189' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
