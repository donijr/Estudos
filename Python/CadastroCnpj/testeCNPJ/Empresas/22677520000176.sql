...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '22677520000176' -- cod_part
                              , 'COMPANHIA DE TECIDOS NORTE DE MINAS COTEMINAS' -- nome
                              , 1 -- dm_tipo_pessoa
                              , 'COTEMINAS' -- fantasia
                              , 'AV LINCOLN ALVES DOS SANTOS' -- lograd
                              , '955' -- nro
                              , '' -- cx_postal
                              , '' -- compl
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/22677520000176' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
