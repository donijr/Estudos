...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '26957386000118' -- cod_part
                              , 'TROPICAL AGROPARTICIPACOES S.A.' -- nome
                              , 1 -- dm_tipo_pessoa
                              , '' -- fantasia
                              , 'SUBIDA SERRA DO MICO' -- lograd
                              , 'S/N' -- nro
                              , '' -- cx_postal
                              , 'SALA 02' -- compl
                              , 'ZONA RURAL' -- bairro
                              , (select ci.id from csf_own.cidade ci where ci.descr = 'Baixa Grande Do Ribeiro') -- cidade_id
                              , 64868000 -- cep 
                              , '1121454411' -- fone
                              , '' -- fax
                              , 'joao.bomfim@coteminas.com.br' -- email
                              , (select es.pais_id from csf_own.estado es where es.id = (select ci.estado_id from csf_own.cidade ci where ci.descr = 'Baixa Grande Do Ribeiro')) -- pais_id
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/26957386000118' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
