...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '28284918000129' -- cod_part
                              , 'COMPANHIA TROPICAL DE ALIMENTOS E PARTICIPACOES' -- nome
                              , 1 -- dm_tipo_pessoa
                              , '' -- fantasia
                              , 'RUA RUA RIO BRANCO' -- lograd
                              , '271' -- nro
                              , '' -- cx_postal
                              , 'BLOCO DA ADMINISTRACAO' -- compl
                              , 'SETOR NOVA ACREUNA' -- bairro
                              , (select ci.id from csf_own.cidade ci where ci.descr = 'Acreuna') -- cidade_id
                              , 75960000 -- cep 
                              , '1121454412' -- fone
                              , '' -- fax
                              , '' -- email
                              , (select es.pais_id from csf_own.estado es where es.id = (select ci.estado_id from csf_own.cidade ci where ci.descr = 'Acreuna')) -- pais_id
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/28284918000129' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
