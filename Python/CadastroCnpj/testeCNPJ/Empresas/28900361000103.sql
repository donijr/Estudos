...
begin
   ...
   insert into csf_own.pessoa ( id
                       ...
                       values ( vn_pessoa_id -- id
                              , 0 -- dm_tipo_incl
                              , '28900361000103' -- cod_part
                              , 'C7S TECNOLOGIA LTDA' -- nome
                              , 1 -- dm_tipo_pessoa
                              , '' -- fantasia
                              , 'RUA PROGRESSO' -- lograd
                              , '150' -- nro
                              , '' -- cx_postal
                              , 'SALA 03' -- compl
                              , 'PROGRESSO' -- bairro
                              , (select ci.id from csf_own.cidade ci where ci.descr = 'Blumenau') -- cidade_id
                              , 89026900 -- cep 
                              , '4721026747' -- fone
                              , '' -- fax
                              , '' -- email
                              , (select es.pais_id from csf_own.estado es where es.id = (select ci.estado_id from csf_own.cidade ci where ci.descr = 'Blumenau')) -- pais_id
   ...
   insert into csf_own.empresa ( id
                        ...
                        values ( vn_empresa_id -- id
                               ...
                               , 5 -- nro_tent_com_scan
                               , 5 -- nro_tent_com_dpec
                               , '/complianceServer/ComplianceFiscal/Integra/28900361000103' -- dir_integra /complianceServer/ComplianceFiscal/Integra/03965963000118/
                               , vn_multorg_id -- multorg_id
                               );
   --
